...
subtitle: It's not. It's functional. Let KC Davis tell you what that means.
date: "2023-02-10"
categories: [I used to think]
---
...
[^1]: Longtime fans will recognize this as a form of introjected regulation, a kind of external regulation within Self-Determination Theory that I [described in a past life](https://medium.com/@vascobrazao/how-to-motivate-a-human-94a45f65659d).

[^2]: Of course, it's never just one thing, but that's a minor detail.
...
KC Davis changed the game. KC is the person behind [StruggleCare.com](http://StruggleCare.com), the TikTok channel [DomesticBlisters](https://www.tiktok.com/@domesticblisters?lang=en), and much more. And this is what she has to say:
...
::: column-margin
Quote from KC Davis on the [Infinite Quest Podcast](https://infinitequestpodcast.com/)'s March 2022 episode entitled [How to Keep House While Drowning With DomesticBlisters](https://open.spotify.com/episode/3ZVNkiKu76CLkspKBsPDQ2?si=38c1361aa5e44c8f)
:::

Right off the bat, she does away with the word "chores". Chores are boring things that you need to do just because you're expected to. Let's forget about chores and focus on **care tasks** instead. Care tasks are entirely functional. You do them because doing them is required to make the spaces you inhabit function for you. You do them to care of yourself and your loved ones. And if doing them is not functional for you, if they don't add anything you value to your life---you don't need to do them![^3]

[^3]: Pro-tip from Catieosaurus: If you hate folding laundry. If you just **can't stand it**. Maybe consider... **not.** (Apply generously over all infected areas.)
...
Perhaps you just internalized that a good mother, husband, carer, however-you-identify *should* maintain a clean kitchen at all times, otherwise you are failing your family, your gender---heck---your nation[^4].
...
[^5]: This is a reference to *Arrested Development*, not a trustworthy figure. I'd count on there being billions of us, actually. Those of you who've reached care task--Nirvana, I salute you. Now get out. Or help me?

# Resources

-   Listen to KC on Infinite Quest (Spotify link): [How to Keep House While Drowning With DomesticBlisters](https://open.spotify.com/episode/3ZVNkiKu76CLkspKBsPDQ2?si=38c1361aa5e44c8f)

-   Watch KC on TikTok: [DomesticBlisters](https://www.tiktok.com/@domesticblisters?lang=en)

-   Find similar content on her Instagram: [strugglecare](https://www.instagram.com/strugglecare/)

-   Read KC's book: [How to Keep House While Drowning: A Gentle Approach to Cleaning and Organizing](https://www.strugglecare.com/book-purchase)

-   Check out KC's own [Resources Page](https://www.strugglecare.com/resources) on her website
